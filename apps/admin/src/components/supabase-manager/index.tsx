...
import { AuthManager } from "@workspace/admin/components/supabase-manager/auth";
import { DatabaseManager } from "@workspace/admin/components/supabase-manager/database";
import { StorageManager } from "@workspace/admin/components/supabase-manager/storage";
import { LogsManager } from "@workspace/admin/components/supabase-manager/logs";
import { SuggestionsManager } from "@workspace/admin/components/supabase-manager/suggestions";
import { UsersManager } from "@workspace/admin/components/supabase-manager/users";
import { SecretsManager } from "@workspace/admin/components/supabase-manager/secrets";
import { SheetNavigationProvider, useSheetNavigation, } from "@workspace/admin/contexts/SheetNavigationContext";
import {
  ChevronLeft,
  ChevronRight,
  Database,
...
import { LogoSupabase } from "@workspace/admin/components/supabase-manager/logo-supabase";
...
function SupabaseManagerContent({ projectRef, isMobile }: { projectRef: string; isMobile?: boolean }) {
          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              ...
              >
                ...
                <span className="flex-1">Powered by Supabase</span>
...
export const SupabaseManager = ({ projectRef, isMobile }: {
  projectRef: string;
  isMobile: boolean;
}) => (
  (
    <QueryClientProvider client={queryClient}>
      ...
      >
        <SupabaseManagerContent projectRef={projectRef} isMobile={isMobile}/>
      </SheetNavigationProvider>
    </QueryClientProvider>
  )
);